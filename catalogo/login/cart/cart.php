...
<body style="background-image:url('images/spider.jpg'); 
...
<form class="form-horizontal" method="post" action="./php/process.php">
  <div class="form-group" >
    <label for="inputEmail3" class="col-sm-2 control-label" ><mark style="background-color:#ffff;">Email del cliente</mark></label>
    <div class="col-sm-5">
      <input type="email" name="email" required class="form-control" id="inputEmail3" placeholder="Email del cliente" style="background-color:#C2FFD0;">
    </div>
  </div>
  <div class="form-group">
